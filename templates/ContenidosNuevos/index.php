            ...
            <? foreach ($noticias as $key => $value) { ?>
                <div class="col-md-3">
                    <table style="height: 100%;">
                        <tr>
                            <td align="center" style="padding: 10px;"><?= $this->Html->image('prensa/'.$value['id'].'.'.$value['img'], array('class'=>'img-fluid')) ?></td>
                        </tr>
                        <tr>
                            <td><h5 class="card-title"><?= $value['titulos'][$idioma] ?></h5></td>
                        </tr>
                        <tr>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><?= $value['titulos'][$idioma] ?></h5>
